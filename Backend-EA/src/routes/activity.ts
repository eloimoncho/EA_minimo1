...
import { postActivityController, updateActivityController, deleteActivityController, getAllActivitiesController, getActivityController } from "../controllers/activity";
...
router.get("/getActivity/:idActivity", getActivityController);
